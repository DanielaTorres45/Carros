...
function listarVehiculos(){
    var salida='';
    for(i in myArrayVeh){
        salida+='<tr><td>'+myArrayVeh[i].placa+'</td><td>'+myArrayVeh[i].marca+
        '</td><td>'+myArrayVeh[i].modelo+'</td><td>'+myArrayVeh[i].color+
        '</td><td>'+myArrayVeh[i].kmr+'</td><td>'+myArrayVeh[i].estado+
        '</td><td class="caja">'+'<img src="'+myArrayVeh[i].imagen +'">'+
        '</td><td>'+(myArrayVeh[i].valor)+'</td><td>'+
...
function editar(pos){
    ...
    document.querySelector('input[name="r1"]:checked').value=myArrayVeh[pos].estado;
